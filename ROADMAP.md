...
- [ ] **Gartenplan: 3D-Ansicht** — ursprünglicher Wunsch war eine 3D-artige Darstellung; MVP ist bewusst 2D (SVG, Top-Down). Das Meter-basierte Koordinatenmodell verbaut eine spätere 3D-Erweiterung nicht, bereitet sie aber auch nicht vor.
