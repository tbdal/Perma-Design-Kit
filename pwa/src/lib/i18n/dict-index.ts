...
export const indexDict: Dict = {
  ...
  pdfScaledBtn: { de: 'PDF (Maßstab)', en: 'PDF (to scale)' },
  pdfScaledTitle: { de: 'Baumscheiben im Maßstab (Kronenbreite der Pflanze), platzsparend auf Papier verteilt', en: 'Tree discs to scale (plant crown width), packed compactly onto the paper' },
  pdfScaledShrunk: { de: '{n} Baumscheibe(n) sind bei diesem Maßstab größer als das Papier und wurden verkleinert.', en: '{n} disc(s) are larger than the paper at this scale and were shrunk to fit.' },
  scaledMinSizeLabel: { de: 'Min. Größe (cm)', en: 'Min. size (cm)' },
  scaledMinSizeTitle: { de: 'Pflanzen, deren Karte bei diesem Maßstab kleiner ausfallen würde, werden nicht gedruckt', en: 'Plants whose card would come out smaller than this at this scale are left out of the PDF' },
  pdfScaledDiscarded: { de: '{n} Pflanze(n) wurden bei diesem Maßstab/Mindestgröße nicht gedruckt: {names}', en: '{n} plant(s) were left out at this scale/minimum size: {names}' },
  ...
  tablePdfTitle: { de: 'Pflanzentabelle — Perma Design Kit', en: 'Plant table — Perma Design Kit' },
  tablePdfPage: { de: 'Seite', en: 'Page' },
  tablePdfMonths: { de: 'Blüte: obere Reihe, Frucht: untere Reihe · H/B in m', en: 'Bloom: top row, fruit: bottom row · H/W in m' },
  tablePdfLegend: { de: 'Legende:', en: 'Legend:' },
  ...
  printCountAllLabel: { de: 'Druckanzahl:', en: 'Print count:' },
  printCountAllBtn: { de: 'für {n} gefilterte setzen', en: 'set for {n} filtered' },
  filterClear: { de: 'Zurücksetzen ×', en: 'Reset ×' },
  filterCount: { de: '{shown} von {total} angezeigt', en: '{shown} of {total} shown' },
  month0: { de: 'Januar', en: 'January' },
  month1: { de: 'Februar', en: 'February' },
  month2: { de: 'März', en: 'March' },
  month3: { de: 'April', en: 'April' },
  month4: { de: 'Mai', en: 'May' },
  month5: { de: 'Juni', en: 'June' },
  month6: { de: 'Juli', en: 'July' },
  month7: { de: 'August', en: 'August' },
  month8: { de: 'September', en: 'September' },
  month9: { de: 'Oktober', en: 'October' },
  month10: { de: 'November', en: 'November' },
  month11: { de: 'Dezember', en: 'December' },
  ...
  lblEatable: { de: 'Essbarkeit', en: 'Edibility' },
  lblScore: { de: 'Score', en: 'Score' },
  lblCulinaric: { de: 'Küche', en: 'Culinary' },
  lblMeds: { de: 'Gesundheit', en: 'Medicinal' },
  lblMaterial: { de: 'Materialien', en: 'Materials' },
  lblFodder: { de: 'Tierfutter', en: 'Fodder' },
  lblFuel: { de: 'Brennstoff', en: 'Fuel' },
  lblWood: { de: 'Nutzholz', en: 'Wood' },
  lblFiber: { de: 'Fasern', en: 'Fiber' },
  lblOrnamental: { de: 'Ästhetik', en: 'Ornamental' },
  lblDyes: { de: 'Farbstoff', en: 'Dyes' },

  fieldsetEcosystem: { de: 'Funktionen', en: 'Functions' },
  lblNitrogenFix: { de: 'Stickstoff-Fixierer', en: 'Nitrogen fixer' },
  lblMineralFix: { de: 'Mineraliensammler', en: 'Dynamic accumulator' },
  lblGroundCover: { de: 'Bodendecker', en: 'Ground cover' },
  lblInsects: { de: 'Insekten', en: 'Invertebrates' },
  lblPest: { de: 'Schädlingsschutz', en: 'Pest control' },
  lblAnimalProtection: { de: 'Kleintiere', en: 'Wildlife' },
