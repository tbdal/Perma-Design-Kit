...
export const datenschutzDict: Dict = {
  ...
  dsAnalyticsTitle: { de: 'Reichweiten­messung mit Umami (selbst gehostet)', en: 'Analytics with Umami (self-hosted)' },
  dsAnalyticsIntro1: {
    de: 'Wir verwenden ein selbst betriebenes',
    en: 'We run our own',
  },
  dsAnalyticsAddress: {
    de: '(läuft auf unserem eigenen Server unter',
    en: '(hosted on our own server at',
  },
  dsAnalyticsIntro2: {
    de: '), um Seitenaufrufe und grobe Nutzungsmuster zu zählen. Es fließen dabei keine Daten an ein drittes Unternehmen — anders als bei Cloud-Analyse-Diensten bleibt alles auf unserer eigenen Infrastruktur. Umami verzichtet ausdrücklich auf personen­bezogene Daten:',
    en: ') to count page views and rough usage patterns. No data leaves our own infrastructure to a third-party company — unlike cloud analytics services, everything stays on our own server. Umami explicitly forgoes personal data:',
  },
  dsAnalyticsLi1: { de: 'keine Cookies, kein Local-Storage durch Umami,', en: 'no cookies, no local storage used by Umami,' },
  dsAnalyticsLi2: {
    de: 'keine Speicherung der IP-Adresse — die Datenbank hat gar keine Spalte dafür; nur ein täglich rotierender, gesalzener Hash aus IP und Browser-Kennung dient zur Sitzungs­zählung und lässt sich nicht auf die IP zurückrechnen,',
    en: 'no storage of the IP address — the database has no column for it at all; only a daily-rotating, salted hash of IP and browser signature is used to count sessions, and cannot be reversed to the IP,',
  },
  dsAnalyticsLi3: { de: 'keine geräte- oder personen­übergreifende Wieder­erkennung,', en: 'no cross-device or cross-person recognition,' },
  dsAnalyticsLi4: { de: 'kein Cross-Site-Tracking.', en: 'no cross-site tracking.' },
  dsAnalyticsBody2: {
    de: 'Erfasst werden ausschließlich aggregierte Werte wie Seitenpfad, Verweis-Domain (Referrer), Land/Region (aus der IP zum Zeitpunkt des Aufrufs abgeleitet, die IP selbst wird dabei nicht gespeichert), Browser- und Geräte-Typ. Eine Einwilligung ist nach Auffassung der Aufsichts­behörden für diese cookielose Form der Reichweiten­messung nicht erforderlich. Das Skript respektiert außerdem die „Do Not Track"-Einstellung deines Browsers, sofern gesetzt.',
    en: 'Only aggregated values are recorded, such as page path, referring domain, country/region (derived from the IP at the moment of the request; the IP itself is not stored), and browser and device type. In the view of the supervisory authorities, consent is not required for this cookieless form of analytics. The script also respects your browser’s "Do Not Track" setting, if set.',
  },
  dsAnalyticsOptOutTitle: { de: 'Reichweiten­messung deaktivieren', en: 'Disabling Analytics' },
  dsAnalyticsOptOutIntro: { de: 'Wenn du nicht gezählt werden möchtest, kannst du die Messung direkt in der App deaktivieren:', en: 'If you do not want to be counted, you can disable analytics directly in the app:' },
  ...
  dsAnalyticsOptOutLabel: { de: 'Reichweitenmessung deaktivieren', en: 'Disable analytics' },
  dsOptOutLi2c: { de: '".', en: '".' },
  ...
  dsOptOutBody3: {
    de: 'gesetzt — ein Opt-out-Signal, das das Umami-Skript automatisch respektiert. Es werden ab dem Zeitpunkt keine weiteren Aufrufe gezählt. Die Einstellung wirkt nur in diesem Browser-Profil und nur, solange du den lokalen Speicher der Seite nicht löschst.',
    en: 'in your browser — an opt-out signal that the Umami script automatically respects. From that point on, no further page views are counted. The setting only applies to this browser profile, and only as long as you don’t clear the site’s local storage.',
  },
  dsAnalyticsAltMethods: {
    de: 'Alternativ helfen browser­seitige Maßnahmen wie ein Tracking-Blocker oder ein Werbe-Blocker mit aktiven EasyPrivacy-Listen.',
    en: 'Alternatively, browser-side measures such as a tracking blocker or an ad blocker with active EasyPrivacy lists can help.',
  },
